 ...
 */
public abstract class CameraOpecCVRendererBase implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private CameraGLSurfaceView.CameraTextureListener texListener;
    ...
    public CameraOpecCVRendererBase(CameraGLSurfaceView.CameraTextureListener cameraTextureListener) {
        ...
        this.texListener =cameraTextureListener;
    }
    ...
    protected void doStop() {
       ...
       // CameraGLSurfaceView.CameraTextureListener listener = mView.getCameraTextureListener();
        if(texListener != null) texListener.onCameraViewStopped();
    ...
    protected void setPreviewSize(int width, int height) {
     ...
     //   CameraGLSurfaceView.CameraTextureListener listener = mView.getCameraTextureListener();
        if(texListener != null)
            ...
            texListener.onCameraViewStarted(mCameraWidth, mCameraHeight);
    }
